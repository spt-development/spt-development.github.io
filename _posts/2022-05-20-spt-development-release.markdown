---
layout: post
title:  "Spring Boot 2.0.5 starters available now"
...
We have also upgraded the [demo project](https://github.com/spt-development/spt-development-demo) to Spring Boot 2.7.0 and v2.0.5 of all the libraries above.
